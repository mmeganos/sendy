...
<html>
	<head>
	    ...
	    <![endif]-->
		<link rel="stylesheet" type="text/css" href="<?php echo get_app_info('path');?>/css/all.css?15" />
		    ...
		    function catch_fatal_error()
			{
			  ...
			  {  
			    ...
			    <div class="alert alert-danger" id="wrapper">
				    <p class="session_error"><h2><span class="icon  icon-exclamation-sign"></span> Some server extensions are not installed</h2></p>
				    <p class="session_error">Some server extensions are not installed. Please check your <a href="'.get_app_info('path').'/_compatibility.php?i=1" target="_blank">server compatibility checklist</a> to see which extensions are not installed.</p>
				    <p class="session_error">Install the required server extensions highlighted in red or contact your hosting support to do so, then reload this page.</p>
			    </div></body></html>';
			  }
